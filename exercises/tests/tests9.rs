...
mod foo {
    #[no_mangle] // Suppress name mangling
    pub fn my_demo_function(a: u32) -> u32 { // Make the function public
        a
    }

    // Define the alias for the function
    pub use my_demo_function as my_demo_function_alias; // Alias
}
...
mod tests {
    ...
    fn test_success() {
        ...
        unsafe {
            ...
            assert_eq!(foo::my_demo_function(456), 456); // Call the function directly
        }
    }
}